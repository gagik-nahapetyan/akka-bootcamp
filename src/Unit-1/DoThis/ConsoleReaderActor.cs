...
namespace WinTail
{
    ...
    class ConsoleReaderActor : UntypedActor
    {
        ...
        /// <summary>
        /// Reads input from console, validates it, then signals appropriate responses
        ...
        private void GetAndValidateInput()
        {
            ...
            {
                // signal that the user needs to supply and input, as previously received input was blank
